            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item active">
                        <a href="<?php echo $appRootURL ?>/home" class="nav-link">Trang Chủ</a>
                    </li>
                    <li class="nav-item">
                        <a href="<?php echo $appRootURL ?>/home/shop" class="nav-link">Sản Phẩm</a>
                    </li>
                    <li class="nav-item">
                        <a href="<?php echo $appRootURL ?>/home/about" class="nav-link">Giới thiệu</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="row mb-5">
                <div class="col-md">
                    <div class="ftco-footer-widget mb-4">
                        <h2 class="ftco-heading-2">TGU Flowers Shop</h2>
                        <p>
                            Chúng tôi hướng đến một dịch vụ chuyên nghiệp trong việc truyền
                            tải những thông điệp, cảm xúc của người tặng đến người nhận.
                        </p>
                        <ul class="
                  ftco-footer-social
                  list-unstyled
                    ...
                    <div class="ftco-footer-widget mb-4">
                        ...
                        <div class="d-flex">
                            <ul class="list-unstyled mr-l-5 pr-l-3 mr-4">
                                <li>
                                    <a href="#" class="py-2 d-block">Chính sách &amp; Điều khoản
                                    </a>
                                </li>
                                <li><a href="#" class="py-2 d-block">Tra cứu đơn hàng</a></li>
                                <li>
                                    <a href="#" class="py-2 d-block">Các lỗi thường gặp</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-md">
                    <div class="ftco-footer-widget mb-4">
                        ...
                        <div class="block-23 mb-3">
                            <ul>
                                <li>
                                    <span class="icon icon-map-marker"></span><span class="text">Mỹ Tho, Tiền Giang</span>
                                </li>
                                <li>
                                    <a href="#"><span class="icon icon-phone"></span><span class="text">+84 123 456 789</span></a>
                                </li>
                                <li>
                                    <a href="#"><span class="icon icon-envelope"></span><span class="text">tguflowers@email.com</span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
