...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Next",sPrevious:"Previous"},sEmptyTable:"No data available in table",sInfo:"Hiển thị _START_ to _END_ of _TOTAL_ bản ghi",sInfoEmpty:"Hiển thị 0 to 0 of 0 bản ghi",sInfoFiltered:"(Đã lọc trong _MAX_ bản ghi)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Hiển thị _MENU_ bản ghi",sLoadingRecords:"Đang tải...",sProcessing:"Đang xử lý...",sSearch:"Tìm kiếm:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},
